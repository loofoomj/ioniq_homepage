...
<%
	...
	NoticeDTO nDto = (NoticeDTO) nDao.boardMod(num);
%>
<body>
<%@ include file="../../templete/header.jsp"%>
<section>
	<div id="main">
		<form name="frm" action="noticeModProcess.jsp?num=<%=num %>" method="post">
		<div id="title_write">글쓰기</div>
			<table>
				<tr>
					<td class="d_1">제목</td>
					<td><input class="inp" type="text" name="title" id="title" value="<%=nDto.getTitle() %>"></td>
				</tr>
				<tr>
					<td class="d_1">작성자</td>
			...
			<textarea rows="" cols="" name="contents" id="contents"><%=nDto.getContent() %></textarea>
